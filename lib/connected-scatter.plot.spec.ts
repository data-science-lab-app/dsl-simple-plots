import { ConnectedScatterPlot } from "./connected-scatter.plot"

describe('Connected Scatter Plot Tests', () => {
    let visualization: ConnectedScatterPlot;

    beforeEach(() => {
        visualization = new ConnectedScatterPlot();
    });
