...
export class ConnectedScatterPlot extends VisualizationPlugin {
    ...
    constructor() {
        super();
        this.options = new ConnectedScatterPlotPluginOptions(this);
        this.inputs = new ConnectedScatterPlotPluginInputs(this);

        this.data = {} as ConnectedScatterPlotInput;
    }
...
class ConnectedScatterPlotPluginInputs extends PluginInputs {
    constructor(public visualization: ConnectedScatterPlot) {
        super();
    }
...
class ConnectedScatterPlotPluginOptions extends PluginOptions {
    state: number;
