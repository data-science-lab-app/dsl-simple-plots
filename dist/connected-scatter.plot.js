...
var ConnectedScatterPlot = /** @class */ (function (_super) {
    __extends(ConnectedScatterPlot, _super);
    function ConnectedScatterPlot() {
        var _this = _super.call(this) || this;
        _this.options = new ConnectedScatterPlotPluginOptions(_this);
        _this.inputs = new ConnectedScatterPlotPluginInputs(_this);
        _this.data = {};
        return _this;
    }
    ConnectedScatterPlot.prototype.getOptions = function () {
        return this.options;
    };
    ConnectedScatterPlot.prototype.getInputs = function () {
        return this.inputs;
    };
    ConnectedScatterPlot.prototype.visualization = function () {
    ...
    ConnectedScatterPlot.prototype.setX = function (points, label) {
        this.data.x = points;
        this.data.xLabel = label;
    };
    ConnectedScatterPlot.prototype.setY = function (points, label) {
        this.data.y = points;
        this.data.yLabel = label;
    };
    ConnectedScatterPlot.prototype.setColor = function (color) {
        this.data.color = color;
    };
    ConnectedScatterPlot.prototype.setTitle = function (title) {
        this.data.title = title;
    };
    ConnectedScatterPlot.prototype.setCurve = function (curve) {
        this.data.curve = curve;
    };
    return ConnectedScatterPlot;
}(data_science_lab_core_1.VisualizationPlugin));
exports.ConnectedScatterPlot = ConnectedScatterPlot;
var ConnectedScatterPlotPluginInputs = /** @class */ (function (_super) {
    __extends(ConnectedScatterPlotPluginInputs, _super);
    function ConnectedScatterPlotPluginInputs(visualization) {
        var _this = _super.call(this) || this;
        _this.visualization = visualization;
        return _this;
    }
    ConnectedScatterPlotPluginInputs.prototype.submit = function (inputs) {
    ...
    ConnectedScatterPlotPluginInputs.prototype.inputs = function () {
        return [
            {
                id: 'x',
                label: 'X Points',
    ...
    return ConnectedScatterPlotPluginInputs;
}(data_science_lab_core_1.PluginInputs));
var ConnectedScatterPlotPluginOptions = /** @class */ (function (_super) {
    __extends(ConnectedScatterPlotPluginOptions, _super);
    function ConnectedScatterPlotPluginOptions(visualization) {
        var _this = _super.call(this) || this;
        _this.visualization = visualization;
        _this.state = 1;
        return _this;
    }
    ConnectedScatterPlotPluginOptions.prototype.submit = function (inputs) {
        if (inputs['title'] !== '') {
    ...
    ConnectedScatterPlotPluginOptions.prototype.options = function () {
        return [
    ...
    ConnectedScatterPlotPluginOptions.prototype.noMore = function () {
        return this.state === 2;
    };
    return ConnectedScatterPlotPluginOptions;
